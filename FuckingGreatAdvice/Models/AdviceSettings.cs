...
/// <summary>Параметры показа совета (только код, не в JSON настроек).</summary>
public sealed class AdviceSettings
{
    ...
    public string FontFamily { get; set; } = "Helvetica LT Pro UltraCompressed";

    public double FontSizePx { get; set; } = 100;
